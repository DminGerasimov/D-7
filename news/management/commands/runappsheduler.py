...
from news.management.commands._weekly_mailing_job import  my_job, weekly_mailing_subscribers
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        logger.info(
            "Added weekly job: 'weekly_mailing_subscribers'."
        )
        try:
